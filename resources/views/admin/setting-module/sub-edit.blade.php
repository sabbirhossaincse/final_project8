            ...
            <div class="col-md-10">
             <h3 class="text-center text-success"></h3>
               ...
               <h2 class="text-center text-success">   {{ Session::get('messages') }}  </h2>
                ...
                <!--  form option-->
                <form class="form-horizontal" action="{{route('update-sub-category')}}" method="POST" enctype="multipart/form-data">
...
<option value="{{$category->id}}" {{$sub_category->category_id == $category->id ? 'selected' : ''}}>{{$category->name}}</option>
  ...
  <!--  <input type="text" class="form-control" name="name" > -->
    ...
    <input type="text" class="form-control" name="name" value="{{$sub_category->name}}">
     ...
     <input type="hidden" class="form-control" name="id" value="{{$sub_category->id}}">
 ...
 <div class="col-sm-9">
    <input type="radio" {{$sub_category->status == 1 ? 'checked' : ''}} name="status" value="1" >


                          Published

     <input type="radio" {{$sub_category->status == 0 ? 'checked' : ''}} name="status" value="0" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="submit" name="btn" value="Create Update Sub Category" class=" form-control btn btn-info" >
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <h3 class="text-center text-success"> {{ Session::get('message') }} </h3>
                  ...
                  <h2> All Edit Sub Category Info Goes Hare</h2>
