             ...
             <h3 class="text-center text-success"></h3>
               ...
               <h2 class="text-center text-success">   {{ Session::get('message') }}  </h2>
                ...
                <form class="form-horizontal" action="" method="POST"> <!-- ai route ta call korta hoba form k dynamic korar jonoo -->
                    ...
                    <h2 class="text-center card-title" >Add Manage Size Form</h2>
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label"> Manage Size Name:</label>
                        <div class="col-sm-9">
                  ...
                  <!-- category descripton option -->
                    ...
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label"> Manage Size Description:</label>
                        <div class="col-sm-9">
